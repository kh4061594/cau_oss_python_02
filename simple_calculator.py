...
while True:
    ...
    if op == "end":
        ...
        ret,num1,num2 = arithmetic_ops(add) # 정의된 함수 사용
    elif op == "*":
        ret,num1,num2 = arithmetic_ops(lambda num1,num2:num1*num2) # 익명함수(lambda) 사용
    #
    # [fill this area] 위의 코드를 참고하여 -, /, %에 대한 내용 구현
    elif op == "-":
        ret,num1,num2 = arithmetic_ops(sub)
    elif op == "/":
        ret,num1,num2 = arithmetic_ops(lambda num1,num2:num1/num2)
    elif op == "%":
        ret,num1,num2 = arithmetic_ops(lambda num1,num2:num1%num2)
    #
    else:
